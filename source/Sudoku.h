...
namespace pze {
  ...
  private:
    ...
    static constexpr int overlaps[54][3] = {
      {  0,  1,  2 }, {  3,  4,  5 }, {  6,  7,  8 },  // Overlap sets  0,  1,  2
      {  9, 10, 11 }, { 12, 13, 14 }, { 15, 16, 17 },  // Overlap sets  3,  4,  5
      { 18, 19, 20 }, { 21, 22, 23 }, { 24, 25, 26 },  // Overlap sets  6,  7,  8
      { 27, 28, 29 }, { 30, 31, 32 }, { 33, 34, 35 },  // Overlap sets  9, 10, 11
      { 36, 37, 38 }, { 39, 40, 41 }, { 42, 43, 44 },  // Overlap sets 12, 13, 14
      { 45, 46, 47 }, { 48, 49, 50 }, { 51, 52, 53 },  // Overlap sets 15, 16, 17
      { 54, 55, 56 }, { 57, 58, 59 }, { 60, 61, 62 },  // Overlap sets 18, 19, 20
      { 63, 64, 65 }, { 66, 67, 68 }, { 69, 70, 71 },  // Overlap sets 21, 22, 23
      { 72, 73, 74 }, { 75, 76, 77 }, { 78, 79, 80 },  // Overlap sets 24, 25, 26

      {  0,  9, 18 }, {  1, 10, 19 }, {  2, 11, 20 },  // Overlap sets 27, 28, 29
      {  3, 12, 21 }, {  4, 13, 22 }, {  5, 14, 23 },  // Overlap sets 30, 31, 32
      {  6, 15, 24 }, {  7, 16, 25 }, {  8, 17, 26 },  // Overlap sets 33, 34, 35
      { 27, 36, 45 }, { 28, 37, 46 }, { 29, 38, 47 },  // Overlap sets 36, 37, 38
      { 30, 39, 48 }, { 31, 40, 49 }, { 32, 41, 50 },  // Overlap sets 39, 40, 41
      { 33, 42, 51 }, { 34, 43, 52 }, { 35, 44, 53 },  // Overlap sets 42, 43, 44
      { 54, 63, 72 }, { 55, 64, 73 }, { 56, 65, 74 },  // Overlap sets 45, 46, 47
      { 57, 66, 75 }, { 58, 67, 76 }, { 59, 68, 77 },  // Overlap sets 48, 49, 50
      { 60, 69, 78 }, { 61, 70, 79 }, { 62, 71, 80 },  // Overlap sets 51, 52, 53
    };

    // Which overlaps are regions made up from?
